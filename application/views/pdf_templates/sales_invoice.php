...
<table class="table table-bordered table-striped">
    ...
    <tr>
        ...
        <th class="text-center"><strong>Owed</strong></th>
    ...
    foreach ($data as $customer) {
        ...
        <tr>
            <td colspan="5"><?php echo $customer->business_name ?></td>
        </tr>
        ...
        foreach ($customer->invoices as $invoice) {
            $salesTotal += $invoice->total;
            $paidTotal += $invoice->paid;
            $owedTotal += ($invoice->total - $invoice->tip);
            ...
            <tr>
                ...
                <td class="text-right"><?php echo number_format($invoice->paid,2); ?></td>
                <td class="text-right"><?php echo number_format(($invoice->total - $invoice->tip),2); ?></td>
                <td class="text-right"><?php echo number_format($invoice->vat,2); ?></td>
...
<?php }elseif($sortType=="date"){?>
    <table class="table table-bordered table-striped">
        ...
        foreach ($data as $date) {
            ...
            <tr>
                <td colspan="5"><?php echo date("d-M-Y", strtotime($date->invoice_date)) ?></td>
            </tr>
