            		...
            		<table class="table table-bordered table-hover table-striped">
                    	<thead>
                        	<tr>
                            	...
                            	<th><?php print lang('item')?></th>
                            	<th><?php print lang('description')?></th>
                            	<th><?php print lang('rate')?></th>
                            	<th></th>
                        	</tr>
                         </thead>
                     	<tbody>
                     		...
                     		if (isset($result) && isset($result[0]))
                     		{
                     			foreach($result as $key=>$val)
                     			{
                     				print '<tr>';
	                     				...
	                     				print '<td>'.$val->rate.'</td>';                     				
	                     				print '<td>';
	                     					print '<a href="'.base_url($this->controller.'/delete/'.$val->rid).'" class="pull-right"><i class="fa fa-trash delete-item" data-message="'.lang('delete_item_question').'"></i></a>';
